from PyQt6.QtWidgets import QMainWindow, QLabel, QLineEdit, QPushButton, QVBoxLayout, QHBoxLayout, QWidget, QMessageBox, QFrame
...
class Login(QMainWindow):
    ...
    def emit_login_signal(self):
        self.signal_manager.login_true.emit()
